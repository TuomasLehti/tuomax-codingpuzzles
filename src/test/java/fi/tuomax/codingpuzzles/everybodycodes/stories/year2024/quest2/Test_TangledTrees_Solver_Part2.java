...
public class Test_TangledTrees_Solver_Part2 {
    ...
    public void test_Solve()
    {
        ...
        try {
            testcase =
                metadata.getTestCase("everybodyCodesStories", 2024, 2, "part2");
        } catch (JSONException | IOException e) {
            fail(e.getMessage());
        }

        TangledTrees_Solver_Part2 solver = new TangledTrees_Solver_Part2();
        assertEquals(

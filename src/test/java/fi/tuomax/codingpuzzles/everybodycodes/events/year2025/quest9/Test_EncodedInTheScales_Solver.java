...
public class Test_EncodedInTheScales_Solver 
extends Test_Solver
{
    ...
    public void test_Part1() 
    {
        ...
        runTest(
            SITE, EVENT, DAY, PART,
            "part1", 
            EncodedInTheScales_Solver_Part1.class
        );
    }
    ...
    public void test_Part2() 
    {
        ...
        runTest(
            SITE, EVENT, DAY, PART,
            "part2", 
            EncodedInTheScales_Solver_Part2.class
        );    
    }
    ...
    public void test_Part3() 
    {
        ...
        runTest(
            SITE, EVENT, DAY, PART,
            "part3one", 
            EncodedInTheScales_Solver_Part3.class
        );    
        runTest(
            SITE, EVENT, DAY, PART,
            "part3other", 

...
//        runPart(metadata.getSite(Site.ID_EC).getEvent(2024).getDay(0).getPart(2));
//        runDay(metadata.getSite(Site.ID_EC).getEvent(2024).getDay(0));
        runSite(metadata.getSite(Site.ID_EC));
    }

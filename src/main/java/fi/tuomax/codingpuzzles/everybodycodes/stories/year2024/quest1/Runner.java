...
public class Runner 
{
    ...
    public static void main(String[] args)
    {
        ...
        try {
            System.out.println("Part 1: " + solverPart1.solve(new Metadata().getInput("everybodyCodesStories", 2024, 1, 1)));
            System.out.println("Part 2: " + solverPart2.solve(new Metadata().getInput("everybodyCodesStories", 2024, 1, 2)));
            System.out.println("Part 3: " + solverPart3.solve(new Metadata().getInput("everybodyCodesStories", 2024, 1, 3)));
        } catch (IOException e) {
